...
# Copyright (c) 2026 Óscar Pons Fernández
...
def generate_launch_description():
    ...
    default_params_file = os.path.join(
        hierarchical_multiagent_langgraph_dir, 'params', 'atomic_params.yaml')
    default_mcp_servers_file = os.path.join(
        hierarchical_multiagent_langgraph_dir, 'params', 'atomic_mcp.json')
    ...
    default_agent_sys_prompt_file = os.path.join(
        hierarchical_multiagent_langgraph_dir, 'templates', 'atomic_agent_system_prompt.jinja')
